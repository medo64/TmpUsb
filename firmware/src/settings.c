...
const uint8_t SettingsRomBlock[BLOCK_ERASE_SIZE] __at(0xF000) = { SETTING_DEFAULT_TIMING_CHARGE_LIMIT_HIGH, SETTING_DEFAULT_TIMING_CHARGE_LIMIT_LOW, SETTING_DEFAULT_ISARMED, SETTING_DEFAULT_ISREADONLY, 0 };
