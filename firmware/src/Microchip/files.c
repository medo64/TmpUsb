...
#if (DRV_FILEIO_CONFIG_INTERNAL_FLASH_MAX_NUM_FILES_IN_ROOT>16)
    const uint8_t PARTITION_ATTRIBUTES(ROOTDIRECTORY1_ADDRESS) RootDirectory1[FILEIO_CONFIG_MEDIA_SECTOR_SIZE] ROOT_DIR_ADDR_TAG + 1 * FILEIO_CONFIG_MEDIA_SECTOR_SIZE =
    {0};
#endif

#if (DRV_FILEIO_CONFIG_INTERNAL_FLASH_MAX_NUM_FILES_IN_ROOT>32)
    const uint8_t PARTITION_ATTRIBUTES(ROOTDIRECTORY2_ADDRESS) RootDirectory2[FILEIO_CONFIG_MEDIA_SECTOR_SIZE] ROOT_DIR_ADDR_TAG + 2 * FILEIO_CONFIG_MEDIA_SECTOR_SIZE =
    {0};
#endif

#if (DRV_FILEIO_CONFIG_INTERNAL_FLASH_MAX_NUM_FILES_IN_ROOT>48)
    const uint8_t PARTITION_ATTRIBUTES(ROOTDIRECTORY3_ADDRESS) RootDirectory3[FILEIO_CONFIG_MEDIA_SECTOR_SIZE] ROOT_DIR_ADDR_TAG + 3 * FILEIO_CONFIG_MEDIA_SECTOR_SIZE =
    {0};
#endif
